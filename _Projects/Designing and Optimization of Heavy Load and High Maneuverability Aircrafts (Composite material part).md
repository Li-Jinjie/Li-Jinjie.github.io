...
2. **Find a** Ukraine-made special **carbon cloth** from a European glider BBS, which weighed merely 30 g/m2, to meet both the stress and the weight requirements.
...
The wing structure is shown as the figure 1. Both the left and right wings are single-spar structures. Each wing is designed in two parts: the front half consists of a spar, the front half ribs and the skin to form a “D” shape closed chamber structure (D-box), shown as the figure 2; the second half consists of balsa wood ribs, trailing edge and heat shrinking film skin. The wings and the fuselage are connected by aluminum pins and the secondary pins.
...
The web of the spar is mainly subjected to shear. Moreover, a variety of woods and PMIs can be used, shown as the figure 4. PMI is selected as the spar web material. 
